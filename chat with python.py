...
class ChatApplication:
    def __init__(self, root):
        self.root = root
        self.root.title("❤❤ Chat With Python ❤❤ ")
        ...
        self.user_label = tk.Label(self.root, text="Kamuu:", font=("Roboto", 12), background="#fafafa")
        ...
        self.responses = {
            "haii python": "haiii jugaaaa",
            "kamu lagi ngapain?": "lagi mikirin dia",
            "yaelahh siapa tuh orangnya": "ada deh",
            "kamu mah gitu gamau ngasih tau": "....",
            "kok kamu diemm?": 
    ...
    def send_message(self):
        ...
        self.conversation.append(("Kamuu", user_message))  
    ...
    def respond_with_delay(self, message):
        ...
        if message.lower() == "haii python":
            self.root.after(100, lambda: self.display_message_lines([response]))
        elif message.lower() == "kamu lagi apa nihh?":
            self.root.after(100, lambda: self.display_message_lines([response]))
    ...
    def display_message_lines(self, lines, index=0):
        if index < len(lines):
            ...
            self.display_message()
            self.root.after(1500, self.display_message_lines, lines, index + 1) 
    ...
    def display_message(self):
        ...
        for sender, msg in self.conversation:
            if sender == "Kamuu":
                self.chat_history.insert(tk.END, f"Kamuu: {msg}\n", "user_message")
            else:
